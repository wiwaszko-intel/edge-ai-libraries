...
-   For more details on Deep Learning Streamer visit [this](https://github.com/open-edge-platform/edge-ai-libraries/blob/release-2025.2.0/libraries/dl-streamer/docs/source/index.md) page.
